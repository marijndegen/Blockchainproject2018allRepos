...
public class AdminDaoImpl extends DaoImpl implements AdminDao {
     ...
     *
     * @return partyListResponse || null when no planned elections are found
     */
    @Override
    public PartyListResponse getPlannedElections() {
        PartyListResponse partyListResponse = new PartyListResponse();
        try {
            con = sqlConnection.getConnection();
    ...
    public List<MemberInfo> getPlannedMembersInElection(int electionId, List<PartyInfo> partyInfos) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                memberInfo.setLocation(rs.getString("gender"));
    ...
    public ElectionInfo getElectionInfo(int electionId) {
        ...
        try {
            ...
            return new ElectionInfo(name, startCalender, endCalender);
        } catch (SQLException e) {
     ...
     */
    @Override
    public void putAdresInDatabase(int electionId, String contractAddress) {
        try {
            con = sqlConnection.getConnection();
